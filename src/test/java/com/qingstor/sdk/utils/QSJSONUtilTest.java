...
public class QSJSONUtilTest {
    ...
    public void testJson() {
        JSONObject convertObj =
                QSJSONUtil.convertJSONObject(
                        "{'testString':'test','testInt':123,'testList':[{'test':'test'}]}");
        ...
        Assert.assertEquals(
                QSJSONUtil.toObject(convertObj, "testList").getClass().getName(),
                "org.json.JSONArray");
    }
    ...
    public void testFillValueJson() {
        ...
        QSJSONUtil.jsonFillValue2Object(
                "{'action':'testowner','instance_set':[{'description':'testgrantee'}]}", output);
