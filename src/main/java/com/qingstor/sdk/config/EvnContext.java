...
public class EvnContext implements ParamValidate {
    ...
    public EvnContext(String accessKey, String accessSecret, String resourceType) {
        this.setAccessKey(accessKey);
        this.setAccessSecret(accessSecret);
        if (QSConstant.SDK_TYPE_IAAS.equals(resourceType)) {
            this.setHost(qingcloudIaasHost);
            this.setUri(default_iaas_uri);
        } else if (QSConstant.SDK_TYPE_STOR.equals(resourceType)) {
