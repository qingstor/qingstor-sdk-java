...
import com.qingstor.sdk.service.Bucket.ListMultipartInput;
...
public class EncryptionTest {
	...
	public void put_encryption_object_with(String objectName, String encryption_algorithm, String encryption_key,
			String encryption_key_md5) throws Throwable {
	...
	public void copy_encryption_object_with(String objectName, String encryption_algorithm, String encryption_key,
			String encryption_key_md5) throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		Bucket.PutObjectInput input = new Bucket.PutObjectInput();
	...
	public void get_encryption_object_with(String objectName, String encryption_algorithm, String encryption_key,
			String encryption_key_md5) throws Throwable {
		// Write code here that turns the phrase above into concrete actions
	...
	@When("^head encryption object with key \"([^\"]*)\" with \"([^\"]*)\", \"([^\"]*)\", \"([^\"]*)\"$")
	public void head_encryption_object_with_key_with(String objectName, String encryption_algorithm,
			String encryption_key, String encryption_key_md5) throws Throwable {
		// Write code here that turns the phrase above into concrete actions
	...
	public void head_encryption_object_status_code_is(int statusCode) throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		System.out.println("head_encryption_object_status_code_is:" + headObjectOutput.getMessage());
